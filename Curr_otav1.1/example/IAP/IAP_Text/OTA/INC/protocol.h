...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "b9pa4ubn"    //开发平台创建产品后生成的16位字符产品唯一标识



#define MCU_VER "1.1.1"                                 //用户的软件版本,用于MCU固件升级,MCU升级版本需修改
#define MCU_APP_VER_NUM      0x010100					//用户的软件版本,用于MCU固件升级,MCU升级版本需修改     				1.0.0
#define MCU_HARD_VER_NUM     0x010100					//用户的硬件版本,当前没有实际用处
#define MCU_VERSION_1					0x01
#define	MCU_VERSION_2					0x01
#define	MCU_VERSION_3					0x01
